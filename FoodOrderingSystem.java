...
public class FoodOrderingSystem extends JFrame implements ActionListener{
    ...
    FoodOrderingSystem(){
        ...
        textHeader = new JLabel("AMAN GAVEL HOTEL MENU");
        textHeader.setBounds(25, 25, 500, 30);
        textHeader.setBackground(Color.BLUE);
        textHeader.setFont(new Font("Times New Roman", Font.PLAIN, 35));

        //EDIT DESCRIPTION
        Description = new JLabel();
        Description.setText("P.O Near Law gate checkpost: 895989XX98  LPU Punjab");
        Description.setBounds(20, 500, 700, 30);
        Description.setBackground(Color.BLUE);
        Description.setFont(new Font("Times New Roman", Font.PLAIN, 25));

        //DECLARE CHECKBOXES
        riceBeans = new JCheckBox("Rice & Beans : 60");
        chapati = new JCheckBox("Chapati : 20");
        tea = new JCheckBox("Tea : 10");
        chips = new JCheckBox("Chana Shamosa : 100");
        stew = new JCheckBox("Thali : 80");
        mandazi = new JCheckBox("Ice-Cream : 20");

        //SET BOUNDS
        riceBeans.setBounds(100, 100, 200, 20);
        chapati.setBounds(100, 150, 200, 20);
        tea.setBounds(100, 200, 200, 20);
        chips.setBounds(100, 250, 300, 20);
